...
import com.lamp.sample.network.model.MagnetData
...
class MagnetometerData constructor(awareListener: AwareListener, context: Context){
    init {
        ...
        Rotation.setSensorObserver {
            ...
            //val value=it.
            if(it != null){
                val magnetData = MagnetData(x,y,z)
                val data = DimensionData(null,null,null,null,null,null,magnetData,null,null,null,null,null,null,null,null,null)
