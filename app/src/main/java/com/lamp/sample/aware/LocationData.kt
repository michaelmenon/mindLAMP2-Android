...
class LocationData constructor(awareListener: AwareListener, context: Context){
   init {
        ...
        Locations.setSensorObserver { data ->
            ...
            if(data != null){
                val dimensionData = DimensionData(null,null,null,null
                ,null,null,null,data.getAsDouble(Locations_Provider.Locations_Data.LONGITUDE),
                    data.getAsDouble(Locations_Provider.Locations_Data.LATITUDE),
                    data.getAsDouble(Locations_Provider.Locations_Data.ALTITUDE),null,null,null,null,null,null)
                val sensorEventRequest = SensorEventRequest(dimensionData,"lamp.gps",System.currentTimeMillis())
