...
class GyroscopeData constructor(awareListener: AwareListener, context: Context) {
    init {
        ...
        Gyroscope.setSensorObserver {
            ...
            //val value=it.
            if(it != null){
                val dimensionData = DimensionData(x,y,z,null,null,null,null,null,null,null,null,null,null,null,null,null)
                val sensorEventRequest = SensorEventRequest(dimensionData,"lamp.gyroscope",System.currentTimeMillis())
