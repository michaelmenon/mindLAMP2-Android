...
import com.lamp.sample.network.model.RotationData
...
class RotationData constructor(awareListener: AwareListener, context: Context){
    init {
        ...
        Rotation.setSensorObserver {
            ...
            //val value=it.
            if(it != null){
                val rotationData = RotationData(x,y,z)
                val data = DimensionData(null,null,null,rotationData,null,null,null,null,null,null,null,null,null,null,null,null)
                val sensorEventRequest = SensorEventRequest(data,"lamp.accelerometer.motion",System.currentTimeMillis())
