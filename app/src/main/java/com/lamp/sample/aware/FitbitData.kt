...
import com.lamp.sample.FitbitActivity
    ...
    private fun readSteps(context: Context) {
        ...
        if (latestSteps != null && latestSteps.moveToFirst()) {
            try {
                ...
                val data = DimensionData(null,null,null,null,null,null,null,null,null,null,null,null,null,totalSteps.toInt(),null,null)
                val sensorEventRequest = SensorEventRequest(data,"lamp.steps",System.currentTimeMillis())
    ...
    private fun readHeartBeat(context: Context) {
        ...
        if (latestHr != null && latestHr.moveToFirst()) {
            try {
                ...
                val data = DimensionData(null,null,null,null,null,null,null,null,null,null,null,null,null,null,"count/min",restingHR)
                val sensorEventRequest = SensorEventRequest(data,"lamp.heart_rate",System.currentTimeMillis())
                listener.getFitbitData(sensorEventRequest)
