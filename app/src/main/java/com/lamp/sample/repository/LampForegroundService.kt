...
import com.lamp.sample.AlarmBroadCastReceiver
import com.lamp.sample.R
import com.lamp.sample.appstate.AppState
import com.lamp.sample.aware.*
import com.lamp.sample.network.model.SensorEventRequest
import com.lamp.sample.notification.LampNotificationManager
import com.lamp.sample.utils.AppConstants
import com.lamp.sample.utils.AppConstants.ALARM_INTERVAL
import com.lamp.sample.utils.AppConstants.INITIAL_TRIGGER
 ...
 */
class LampForegroundService : Service(), AwareListener {
    ...
    private fun collectSensorData() {
        ...
        val timer = object: CountDownTimer(60000, 3000) {
            override fun onTick(millisUntilFinished: Long) {
                count++
                when(count){
                    1 -> FitbitData(this@LampForegroundService,applicationContext)
                    2 -> AccelerometerData(this@LampForegroundService,applicationContext)//Invoke Accelerometer Call
                    3 -> RotationData(this@LampForegroundService,applicationContext) //Invoke Rotation Call
                    4 -> MagnetometerData(this@LampForegroundService,applicationContext) //Invoke Magnet Call
                    5 -> GyroscopeData(this@LampForegroundService,applicationContext)//Invoke Gyroscope Call
                    6 -> LocationData(this@LampForegroundService,applicationContext)//Invoke Location
                    7 -> WifiData(this@LampForegroundService,applicationContext)//Invoke WifiData
                    8 -> ScreenStateData(this@LampForegroundService,applicationContext)
                }
            }
